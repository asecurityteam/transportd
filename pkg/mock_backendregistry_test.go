...
func (m *MockBackendRegistry) Load(arg0 context.Context, arg1 string) Backend {
	m.ctrl.T.Helper()
...
func (m *MockBackendRegistry) Store(arg0 context.Context, arg1 string, arg2 Backend) {
	m.ctrl.T.Helper()
